...
public class HospitalManagementSystem {
    ...
    public static void bookapointment(Patient patient, Doctor doctor, Connection connection, Scanner scanner){
        ...
        if (patient.getPatientbyId(patientId) && doctor.getDoctorbyId(doctorId)){
            if (checkDoctorAvailibility(doctorId, appointmentDate, connection)){
                ...
                System.out.println("Doctor not available on this Dtae!!");
            }
